...
insert into products(name,category_id, serie_id, price, discount, description, image, deleted, stock)
values("Llavero Totoro varios modelos", 6, 10, 690, 10, "Llavero totoro excelente calidad. El material es de PVC. El precio es por unidad. Altura 8 cm. Ancho 4 cm. Incluye gancho","/img/productos/3/llavero3.png",0, 50);
insert into products(name,category_id, serie_id, price, discount, description, image, deleted, stock)
...
insert into products(name,category_id, serie_id, price, discount, description, image, deleted, stock)
values("Prendedores Pins Demon Slayer Nezuko", 7, 8,75,0,"Prendedores Pins Demon Slayer Nezuko. Excelente calidad. Diseño a elección", "/img/productos/5/pin5.png", 0,100);
insert into products(name,category_id, serie_id, price, discount, description, image, deleted, stock)
...
insert into products(name,category_id, serie_id, price, discount, description, image, deleted, stock)
values("Pokemon - Cuadros Personalizados - Todos Los Personajes", 3, 7, 1700, 10, "Lámina sobre bastidor sin marco. Tamaño: 20cm x 30cm. Imagen a elección. Se puede personalizar para colgarlo de manera vertical u horizontal.","/img/productos/16/cuadro16.png", 0, 4);
insert into products(name,category_id, serie_id, price, discount, description, image, deleted, stock)
values("Cuadros Poster Pokemon Eevee Evolucion 60x90 (suv 5)", 3, 7, 1950, 0, "Lámina sobre bastidor sin marco. Tamaño: 20cm x 30cm. Imagen a elección. Se puede personalizar para colgarlo de manera vertical u horizontal.","/img/productos/17/cuadro17.png", 0, 5);
insert into products(name,category_id, serie_id, price, discount, description, image, deleted, stock)
values("Remera Algodón Anime Otaku Manga Todas Las Series Hombre", 2, 13, 1950, 0, "Remera de Algodón Peinado 24.1 de excelente calidad. Estampado de Vinilo Textil calidad premium. Contamos con varios modelos! - Consultanos por el que estás buscando. Tabla de Medidas: Talle 1/S: 63 x 48 cm; Talle 1/S: 63 x 48 cm; Talle 3/L: 69 x 52 cm; Talle 4 /XL: 72 x 54 cm; Talle 5/XXL: 75 x 58 cm", "/img/productos/18/indumentaria18.png", 0, 15);
insert into products(name,category_id, serie_id, price, discount, description, image, deleted, stock)
...
insert into products(name,category_id, serie_id, price, discount, description, image, deleted, stock)
values("Pantalon Pokemon Pikachu Charmander Bulbasor Squirtle", 2, 7, 3200, 15, "Pantalón unisex de Pokemon confeccionado en Tela de Poliéster. Cómodos y livianos. Bolsillos Laterales y bolsillo trasero (lado derecho). Presentación en bolsa acordonada porta pantalón.","/img/productos/20/indumentaria20.png", 0, 9);
insert into products(name,category_id, serie_id, price, discount, description, image, deleted, stock)
values("Campera Demon Slayer Anime Diseño Exclusivo", 2, 8, 3900, 5, "Camperitas con diseños exclusivos. Confeccionado en ketten frisado (temporada intermedia) con sublimado full print. El ketten es una tela cuya composición es polyester.","/img/productos/21/indumentaria21.png", 0, 5);
insert into products(name,category_id, serie_id, price, discount, description, image, deleted, stock)
values("Manga Pokemon Yellow Editorial Panini Dgl Games & Comics", 1, 7, 800, 0, "Han pasado dos años desde que Red y sus amigos derrotaron al Equipo Rocket en Silph S.A. Bruno, un miembro del Alto Mando, lanzó un reto para Red. Él salió a enfrentar el desafío con valentía, pero desapareció. Pikachu fue el único que regresó pero sus heridas son graves. Yellow tomó a Pikachu bajo su cuidado y partió en busca de Red.", "/img/productos/22/manga22.png", 0, 10);