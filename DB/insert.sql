...
insert into products(name,category_id, serie_id, price, discount, description, image, deleted, stock)
values("Figura de acción Naruto Shippuden Itachi Uchiha", 4, 2, 9000,20, "Bandai es una de las mayores empresas representantes de la cultura animé en Japón. Con sus juguetes y figuras de acción es una de las preferidas por los más pequeños y por quienes se dedican a coleccionar. Las figuras de acción están hechas de plástico lo que asegura que sean amables y suaves al tacto, diferenciando las distintas texturas y relieves del cuerpo de los personajes. Al tener marcadas las articulaciones podrás manejar y acomodar tus figuras como más te guste. Con ellas, vas a poder crear historias en la que los personajes puedan movilizarse y cobrar vida.", "/img/productos/10/figura10.png", 0, 4);
insert into products(name,category_id, serie_id, price, discount, description, image, deleted, stock)
values("Juguete Dragon Ball Z Gogeta Super Saiyan Blue", 4, 1, 3200,15, "Nuevo en blister. No son articulados. Medidas 18x5x4 aproximadamente. Son importados", "/img/productos/11/figura11.png", 0, 3);
insert into products(name,category_id, serie_id, price, discount, description, image, deleted, stock)
values("Juguete Dragon Ball Z Vegeta Super Saiyan Fase Dios", 4, 1, 3200,10, "Nuevo en blister. No son articulados. Medidas 18x5x4 aproximadamente. Son importados", "/img/productos/12/figura12.png", 0, 3);
insert into products(name,category_id, serie_id, price, discount, description, image, deleted, stock)
